...
Database.then(async (db) => {
    ...
    // o horárioque a pessoa trabalha, por exemplo, é das 8h - 18h
    // p horário do time_from (8h) precisa ser menor ou igual ao horário solicitado
    // o time_to precisa de acima
